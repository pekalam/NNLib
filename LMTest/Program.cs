...
namespace LMTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new PerceptronLayer(1,80, new TanHActivationFunction(), new XavierMatrixBuilder()),
                new PerceptronLayer(80,10, new TanHActivationFunction(), new XavierMatrixBuilder()),
